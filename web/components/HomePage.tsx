...
export default function HomePage({ onStart, onRecommendMode }: HomePageProps) {
  ...
  return (
    <div className="bg-transparent relative size-full flex flex-col overflow-auto" suppressHydrationWarning>
      {/* 公共标题栏 */}
      <CommonHeader />
      ...
      <div className="flex-1 w-full flex flex-col items-center justify-center px-4 sm:px-8 lg:px-16 py-8 sm:py-12 relative z-10">
        ...
        <div className="w-full max-w-4xl mb-6">
          <label className="block text-[#c1c5cc] text-sm mb-3 px-2">选择艺术风格</label>
            ...
            {ART_STYLES.map((style) => (
              ...
              >
                <div className="text-left">
                  <p className="text-[#e8e8ec] text-sm font-medium">{style.nameCn}</p>
