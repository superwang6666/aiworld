...
interface OAuthButtonsProps {
  dividerLabel: string;
  actionLabel: (provider: string) => string;
  isLoading: boolean;
  onSignInStart: () => void;
}
    ...
    <>
      ...
      <div className="space-y-3">
        ...
        >
          ...
          {actionLabel(PROVIDER_DISPLAY_NAMES.google)}
        </button>
        ...
        >
          ...
          {actionLabel(PROVIDER_DISPLAY_NAMES.discord)}
        </button>
        ...
        >
          ...
          {actionLabel(PROVIDER_DISPLAY_NAMES.twitter)}
        </button>
      </div>
    </>
  );
